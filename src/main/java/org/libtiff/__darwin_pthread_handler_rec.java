...
public class __darwin_pthread_handler_rec {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        tiffconf_h.C_POINTER.withName("__routine"),
        tiffconf_h.C_POINTER.withName("__arg"),
        tiffconf_h.C_POINTER.withName("__next")
    ...
    public static class __routine {
        ...
        private static final MethodHandle UP$MH = tiffconf_h.upcallHandle(__routine.Function.class, "apply", $DESC);
