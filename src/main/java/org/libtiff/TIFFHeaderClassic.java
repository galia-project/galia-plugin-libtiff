 ...
 * }
 */
public class TIFFHeaderClassic {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        tiffio_h.C_INT.withName("tiff_diroff")
    ).withName("$anon$110:9");
    ...
    private static final OfInt tiff_diroff$LAYOUT = (OfInt)$LAYOUT.select(groupElement("tiff_diroff"));
     ...
     * }
     */
    public static final OfInt tiff_diroff$layout() {
        return tiff_diroff$LAYOUT;
    }

    private static final long tiff_diroff$OFFSET = 4;
     ...
     * }
     */
    public static int tiff_diroff(MemorySegment struct) {
     ...
     * }
     */
    public static void tiff_diroff(MemorySegment struct, int fieldValue) {
