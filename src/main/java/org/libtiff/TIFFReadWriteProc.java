 ...
 * }
 */
public class TIFFReadWriteProc {
    ...
    private static final MethodHandle UP$MH = tiffio_h.upcallHandle(TIFFReadWriteProc.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(TIFFReadWriteProc.Function fi, Arena arena) {
