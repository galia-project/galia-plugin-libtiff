...
public class TIFFSeekProc {
    ...
    private static final MethodHandle UP$MH = tiffio_h.upcallHandle(TIFFSeekProc.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(TIFFSeekProc.Function fi, Arena arena) {
